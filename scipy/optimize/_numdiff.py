    ...
    method : {'3-point', '2-point'}, optional
        Finite difference method to use:
            ...
            - '3-point' - use central difference in interior points and the
                          ...
                          near the boundary.
            - 'cs' - use a complex-step finite difference scheme. Can produce
                     bogus results if the user function cannot handle complex
                     arguments (or is itself complex-valued).
