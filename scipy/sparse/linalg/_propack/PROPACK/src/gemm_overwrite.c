...
void sgemm_ovwr(const CBLAS_INT transa, CBLAS_INT m, CBLAS_INT n, CBLAS_INT k, float alpha,
...
void dgemm_ovwr(
    const CBLAS_INT transa, CBLAS_INT m, CBLAS_INT n, CBLAS_INT k, double alpha, double* restrict A, CBLAS_INT lda, double beta,
