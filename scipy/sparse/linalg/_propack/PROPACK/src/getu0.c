...
void sgetu0(CBLAS_INT transa, CBLAS_INT m, CBLAS_INT n, CBLAS_INT j, CBLAS_INT ntry, float* u0, float* u0norm, float* U, CBLAS_INT ldu,
...
void dgetu0(CBLAS_INT transa, CBLAS_INT m, CBLAS_INT n, CBLAS_INT j, CBLAS_INT ntry, double* u0, double* u0norm, double* U, CBLAS_INT ldu,
...
void cgetu0(CBLAS_INT transa, CBLAS_INT m, CBLAS_INT n, CBLAS_INT j, CBLAS_INT ntry, PROPACK_CPLXF_TYPE* u0, float* u0norm, PROPACK_CPLXF_TYPE* U, CBLAS_INT ldu,
...
void zgetu0(CBLAS_INT transa, CBLAS_INT m, CBLAS_INT n, CBLAS_INT j, CBLAS_INT ntry, PROPACK_CPLX_TYPE* u0, double* u0norm, PROPACK_CPLX_TYPE* U, CBLAS_INT ldu,
