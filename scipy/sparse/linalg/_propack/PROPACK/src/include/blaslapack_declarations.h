...
BLAS_FUNC(cdotc)(const CBLAS_INT* n, const PROPACK_CPLXF_TYPE* restrict x, const CBLAS_INT* incx, const PROPACK_CPLXF_TYPE* restrict y, const CBLAS_INT* incy)
{
...
BLAS_FUNC(zdotc)(const CBLAS_INT* n, const PROPACK_CPLX_TYPE* restrict x, const CBLAS_INT* incx, const PROPACK_CPLX_TYPE* restrict y, const CBLAS_INT* incy)
{
