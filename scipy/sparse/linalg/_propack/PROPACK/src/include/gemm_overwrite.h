 ...
 */
void sgemm_ovwr(const CBLAS_INT transa, CBLAS_INT m, CBLAS_INT n, CBLAS_INT k, float alpha, float* restrict A, CBLAS_INT lda, float beta, float* restrict B, CBLAS_INT ldb, float* restrict work, CBLAS_INT blocksize);
 ...
 * @param blocksize number of columns to process at once
 */
void dgemm_ovwr(const CBLAS_INT transa, CBLAS_INT m, CBLAS_INT n, CBLAS_INT k, double alpha, double* restrict A, CBLAS_INT lda, double beta, double* restrict B, CBLAS_INT ldb, double* restrict work, CBLAS_INT blocksize);
