...
// ==================================================================================
// Random 64bit integer generator for random floating poCBLAS_INT number purposes; based on
...
void sbsvdstep(const CBLAS_INT jobu, const CBLAS_INT jobv, CBLAS_INT m, CBLAS_INT n, CBLAS_INT k, float sigma, float* D, float* E, float* U, CBLAS_INT ldu, float* V, CBLAS_INT ldv)
{
    CBLAS_INT int1 = 1;
    float c, s, r;
...
void dbsvdstep(const CBLAS_INT jobu, const CBLAS_INT jobv, CBLAS_INT m, CBLAS_INT n, CBLAS_INT k, double sigma, double* D, double* E, double* U, CBLAS_INT ldu, double* V, CBLAS_INT ldv)
{
    CBLAS_INT int1 = 1;
    double c, s, r;
    // Perform an implicit LQ SVD sweep with shift sigma.
